...
const IssuesMap = dynamic(() => import("@/components/IssuesMap"), {
  ssr: false,
  loading: () => (
    <div className="flex h-[400px] items-center justify-center rounded bg-gray-100 dark:bg-gray-800">
      Loading map...
    </div>
  ),
});
      ...
      <div className="mx-auto max-w-6xl p-6">
        ...
        <div className="mb-6 flex flex-col gap-3 sm:flex-row">
          <input
            ...
            className="flex-1 rounded border border-gray-300 bg-white p-2 text-gray-800 dark:border-gray-600 dark:bg-gray-800 dark:text-white"
          />
          <select
            value={categoryFilter}
            onChange={(e) => setCategoryFilter(e.target.value)}
            className="rounded border border-gray-300 bg-white p-2 text-gray-800 dark:border-gray-600 dark:bg-gray-800 dark:text-white"
          >
              ...
              return (
                ...
                >
                  ...
                  <div className="mb-2 flex items-center justify-between">
                    <span className="rounded bg-gray-100 px-2 py-1 text-xs font-medium text-gray-700 dark:bg-gray-700 dark:text-gray-200">
                  ...
                  <Link href={`/issues/${issue.id}`}>
                    <h3 className="mb-1 font-semibold text-gray-800 hover:text-blue-600 hover:underline dark:text-white dark:hover:text-blue-400">
                      {issue.title}
                    </h3>
                  </Link>

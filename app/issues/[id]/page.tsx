...
export default function IssueDetailPage() {
  ...
  if (!issue) {
    return (
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
        <p className="p-6 text-gray-500 dark:text-gray-400">Issue not found.</p>
      </div>
    );
  }
          ...
          {isEditing ? (
            <div className="mb-4 space-y-3">
              <input
                ...
                className="w-full rounded border border-gray-300 bg-white p-2 text-lg font-bold text-gray-800 dark:border-gray-600 dark:bg-gray-700 dark:text-white"
              />
              <textarea
          ...
          <div className="border-t pt-4 dark:border-gray-700">
            ...
            <form onSubmit={handleCommentSubmit} className="mb-6 flex gap-2">
              <input
                ...
                className="flex-1 rounded border border-gray-300 bg-white p-2 text-gray-800 disabled:bg-gray-50 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:disabled:bg-gray-800"
              />
              <button
                type="submit"
